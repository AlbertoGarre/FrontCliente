...
const HeaderCliente = ({ title, onAdd, showAdd, paginaActual }) => {
    ...
    return (
        <nav id="header" className="cristal navbar navbar-expand-md text-dark fixed-top navbar-light">
            ...
            <Link className={"h5 nav-item mr-4 nav-link bg-transparent pb-2" + (paginaActual == "/NuevoEnvio" ? " text-success border-bottom border-success" : " text-dark")} to="/NuevoEnvio">Enviar</Link>
