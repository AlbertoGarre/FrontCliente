...
const HeaderCliente = ({ title, onAdd, showAdd }) => {
  ...
  return (
    ...
    <div className="nav-item">
      <Link className="nav-link bg-transparent text-success border-bottom border-success pb-2" to="/NuevoEnvio">Enviar</Link>
    </div>
    ...
    <div className="collapse navbar-collapse" id="navbarsExample03">
      ...
      <Link className="my-2 my-md-0 text-dark" to="/Acceso">
        Usuarios
      </Link>
    </div>
